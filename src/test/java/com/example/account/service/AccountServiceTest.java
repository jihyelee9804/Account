...
class AccountServiceTest {
    /**
     * 테스트 케이스
     * 1. 계좌생성정상케이스일 때 계좌번호 1 증가 후 새 계좌 생성
     * 2. 계좌최초생성일 때 계좌번호 1000000000으로 계좌 생성
     * 3. 해당 유저 없음 - 계좌 생성 실패
     * 4. 유저당 최대 계좌는 10개
     */
    @MockBean
    ...
    @InjectMocks // AccountRepository,AccountUserRepository Mock이 주입된 accountService가 생성된다.
    ...
    @Test
    @DisplayName("계좌 해지 실패 - 미등록 계좌")
    void deleteAccountFail_unregisteredAccount() {
        //given
        AccountUser pobi = AccountUser.builder()
                .id(12L)
                .name("Pobi").build();
